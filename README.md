...
│   ├── StoryEditorActivity.java  # 獨立繪本編輯工作台 (跨頁章節、配圖、文字、排序增刪)
...
- 📦 `/sdcard/Download/CrewStory-v1.0.8.apk` (或 `/sdcard/Download/CrewStory.apk`)
...
- 點選卡片下方的「✏️ 編輯」按鈕，即可進入編輯器隨心調整每一頁的插圖、文字與對白。
